...
extern int calc_sht11_temp(unsigned int t);
extern uint8_t rhcalc_int(unsigned int s);
extern uint8_t calc_sht11_humi(unsigned int h, int t);
...
void init_cnt2 (void);
extern uint8_t sht11_temp(int *temp_value);
extern uint8_t sht11_humidity(int *humi_value); 
