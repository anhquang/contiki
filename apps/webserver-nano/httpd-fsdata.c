/*********Generated by contiki/tools/makefsdata on 2013-04-24*********/
...
*/
const struct httpd_fsdata_file       file_tcp_shtml[] HTTPD_STRING_ATTR ={{                NULL, data_tcp_shtml     , data_tcp_shtml      +11, sizeof(data_tcp_shtml)       -11}};
const struct httpd_fsdata_file    file_status_shtml[] HTTPD_STRING_ATTR ={{      file_tcp_shtml, data_status_shtml  , data_status_shtml   +14, sizeof(data_status_shtml)    -14}};
const struct httpd_fsdata_file     file_files_shtml[] HTTPD_STRING_ATTR ={{   file_status_shtml, data_files_shtml   , data_files_shtml    +13, sizeof(data_files_shtml)     -13}};
const struct httpd_fsdata_file        file_404_html[] HTTPD_STRING_ATTR ={{    file_files_shtml, data_404_html      , data_404_html       +10, sizeof(data_404_html)        -10}};
const struct httpd_fsdata_file     file_index_shtml[] HTTPD_STRING_ATTR ={{       file_404_html, data_index_shtml   , data_index_shtml    +13, sizeof(data_index_shtml)     -13}};
